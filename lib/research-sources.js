...
async function searchOpenAlex(query, { page = 1, perPage = 20, yearFrom, openAccessOnly, pubmedOnly, advanced } = {}) {
  const filters = [];
...
async function searchEuropePmc(query, { page = 1, perPage = 20, yearFrom, openAccessOnly, pubmedOnly, advanced } = {}) {
