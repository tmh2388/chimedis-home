...
// Định nghĩa từng "hạng mục" (track) cha trong cây menu — hạng mục nào dùng gate nào.
// msc_thesis/phd_thesis dùng đủ 25 Gate (0-24). intl_paper rút gọn theo loại nghiên cứu
// (khớp đúng phần "Chuẩn tham chiếu" ở Gate 9) — không cần chạy hết luận văn/bảo vệ.
// report dùng lõi tối thiểu để ra một báo cáo nghiên cứu ngắn.
export const TRACK_TYPES = {
  ...
  intl_paper: {
    label: { vi: 'Bài báo quốc tế', zh: '国际期刊论文', en: 'International paper' },
    icon: 'ti-article',
    // Không có sẵn 1 danh sách gate cố định — mỗi bài con (study_design) tự chọn subset khi tạo.
    gates: null,
    studyDesigns: {
      ...
      systematic_review: { label: { vi: 'Systematic review / Meta-analysis', zh: '系统综述/Meta 分析', en: 'Systematic review / meta-analysis' }, standard: 'PRISMA', gates: [2, 3, 5, 8, 9, 16, 17, 18, 19, 20] },
      ...
      prediction: { label: { vi: 'Nghiên cứu dự đoán/chẩn đoán', zh: '预测/诊断研究', en: 'Prediction / diagnostic study' }, standard: 'TRIPOD/TRIPOD+AI', gates: [2, 3, 5, 6, 7, 8, 9, 16, 17, 18, 19, 20] },
      case_report: { label: { vi: 'Báo cáo ca bệnh (case report/series)', zh: '病例报告/系列', en: 'Case report / case series' }, standard: 'CARE', gates: [2, 3, 9, 17, 18, 19, 20] },
  ...
  report: {
    label: { vi: 'Báo cáo nghiên cứu', zh: '研究报告', en: 'Research report' },
    icon: 'ti-report',
...
export function gatesForTrack(trackType, studyDesign) {
  ...
  if (trackType === 'intl_paper' && studyDesign && def.studyDesigns[studyDesign]) {
