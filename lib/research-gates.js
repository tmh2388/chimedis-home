...
// thesis dùng đủ 25 Gate. Các loại bài báo dùng subset Gate phù hợp bản chất (case report
// không cần sample-size/randomization; protocol dừng lại trước khi có kết quả).
// Luận văn Thạc sĩ/Tiến sĩ GỘP CHUNG 1 mục "thesis" (2026-09-18, theo yêu cầu user sau khi rà
// soát: khác nhau ở TIÊU CHUẨN/KẾT QUẢ đầu ra (số bài công bố, mức độ nguyên bản, số vòng phản
// biện — và khác NHAU TUỲ TRƯỜNG, không có 1 chuẩn chung), nhưng quy trình 25 Gate là 1 — nên
// KHÔNG tách thành 2 danh mục cha riêng. Nếu sau này cần phân biệt rõ, thêm studyDesigns con
// (vd. { msc:{...}, phd:{...} }) đúng theo cách "original_research" đang làm với RCT/Cohort,
// KHÔNG tách lại thành 2 mục cha như cũ.
export const TRACK_TYPES = {
  thesis: {
    label: { vi: 'Luận văn / Luận án', zh: '学位论文', en: 'Thesis / dissertation' },
    icon: 'ti-school',
