...
> - Ngày chạy: 2026-09-09T09:59:03.300Z
...
| B08 | discovery | `đàm nhiệt tâm ("insomnia" OR "sleeplessness" OR "sleep disorder")` | mất ngủ→insomnia | high | — | đàm | nhiệt | tâm | false | unresolved kept: đàm,nhiệt,tâm | SILENT-DROP: «nhiễu» | SILENT-DROP: «và» |
...
| D09 | discovery | `ôn đởm thang ("treatment" OR "therapy" OR "therapeutic" OR "management") đàm nhiệt tâm` | điều trị→treatment | high | — | ôn | đởm | thang | đàm | nhiệt | tâm | false | unresolved kept: ôn,đởm,thang,đàm,nhiệt,tâm | SILENT-DROP: «nhiễu» |
| D10 | discovery | `đại thừa thang ("treatment" OR "therapy" OR "therapeutic" OR "management") "constipation"` | điều trị→treatment ; táo bón→constipation | high,high | — | đại | thừa | thang | false | unresolved kept: đại,thừa,thang | SILENT-DROP: «khí» |
...
| P02 | discovery | `trần thị ("acupuncture" OR "needle acupuncture" OR "manual acupuncture" OR "body acupuncture")` | châm→acupuncture | high | — | trần | thị | false | unresolved kept: trần,thị |
...
| Q04·d | discovery | `"KIDNEY" hư toàn "Torso" không phù` | thận→KIDNEY ; thân→Torso | medium,medium | — | hư | toàn | không | phù | false | unresolved kept: hư,toàn,không,phù | SILENT-DROP: «nhưng» |
| Q04·e | evidence | `"KIDNEY" hư toàn "Torso" không phù` | thận→KIDNEY ; thân→Torso | medium,medium | — | hư | toàn | không | phù | true | unresolved kept: hư,toàn,không,phù | SILENT-DROP: «nhưng» |
...
mode              : discovery
effective_query   : đàm nhiệt tâm ("insomnia" OR "sleeplessness" OR "sleep disorder")
...
confidence        : high
ambiguous         : —
unresolved        : đàm | nhiệt | tâm
needs_resolution  : false
warning           : Chưa dịch được: «đàm», «nhiệt», «tâm» (giữ nguyên văn trong truy vấn)
nhận xét (máy)    : unresolved kept: đàm,nhiệt,tâm | SILENT-DROP: «nhiễu» | SILENT-DROP: «và»
engine_version    : te-v2-d1
```
...
mode              : discovery
effective_query   : ôn đởm thang ("treatment" OR "therapy" OR "therapeutic" OR "management") đàm nhiệt tâm
...
confidence        : high
ambiguous         : —
unresolved        : ôn | đởm | thang | đàm | nhiệt | tâm
needs_resolution  : false
warning           : Chưa dịch được: «ôn», «đởm», «thang», «đàm», «nhiệt», «tâm» (giữ nguyên văn trong truy vấn)
nhận xét (máy)    : unresolved kept: ôn,đởm,thang,đàm,nhiệt,tâm | SILENT-DROP: «nhiễu»
engine_version    : te-v2-d1
```
...
mode              : discovery
effective_query   : đại thừa thang ("treatment" OR "therapy" OR "therapeutic" OR "management") "constipation"
...
confidence        : high,high
ambiguous         : —
unresolved        : đại | thừa | thang
needs_resolution  : false
warning           : Chưa dịch được: «đại», «thừa», «thang» (giữ nguyên văn trong truy vấn)
nhận xét (máy)    : unresolved kept: đại,thừa,thang | SILENT-DROP: «khí»
engine_version    : te-v2-d1
```
...
spans             : châm cứu·translate→acupuncture(high)  or·unresolved  điện châm·translate→electroacupuncture(high)  and·unresolved  đột quỵ·translate→stroke(high)
...
spans             : hoàng kỳ·translate→Astragalus membranaceus(high)  and·unresolved  đột quỵ·translate→stroke(high)  or·unresolved  thiếu·unresolved  máu·unresolved  não·translate→part of the brain(medium)
concept đã chọn   : hoàng kỳ→Astragalus membranaceus ; đột quỵ→stroke ; não→part of the brain
confidence        : high,high,medium
ambiguous         : —
unresolved        : and | or | thiếu | máu
needs_resolution  : false
warning           : Chưa dịch được: «and», «or», «thiếu», «máu» (giữ nguyên văn trong truy vấn)
nhận xét (máy)    : unresolved kept: and,or,thiếu,máu | SUSPECT-MAP: não→part of the brain
engine_version    : te-v2-d1
```
...
input             : Trần Thị Châm
mode              : discovery
effective_query   : trần thị ("acupuncture" OR "needle acupuncture" OR "manual acupuncture" OR "body acupuncture")
spans             : trần·unresolved  thị·unresolved  châm·translate→acupuncture(high)
concept đã chọn   : châm→acupuncture
confidence        : high
ambiguous         : —
unresolved        : trần | thị
needs_resolution  : false
warning           : Chưa dịch được: «trần», «thị» (giữ nguyên văn trong truy vấn)
nhận xét (máy)    : unresolved kept: trần,thị
engine_version    : te-v2-d1
```
...
mode              : discovery
effective_query   : "KIDNEY" hư toàn "Torso" không phù
...
confidence        : medium,medium
ambiguous         : —
unresolved        : hư | toàn | không | phù
needs_resolution  : false
warning           : Chưa dịch được: «hư», «toàn», «không», «phù» (giữ nguyên văn trong truy vấn)
nhận xét (máy)    : unresolved kept: hư,toàn,không,phù | SILENT-DROP: «nhưng»
engine_version    : te-v2-d1
```
